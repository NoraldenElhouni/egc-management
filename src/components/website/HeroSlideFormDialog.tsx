...
const HeroSlideFormDialog: React.FC<HeroSlideFormDialogProps> = ({
  isOpen,
  onClose,
  onSubmit,
  loading = false,
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose}>
      <form
        ...
        noValidate
      >
        <h2 className="text-lg font-bold">صورة شريحة جديدة</h2>
        ...
        <div className="flex flex-col gap-2">
          ...
          {previewUrl ? (
            ...
            <div className="w-full aspect-[16/7] rounded-lg border border-dashed border-gray-300 flex flex-col items-center justify-center gap-2 text-gray-400">
...
export default HeroSlideFormDialog;
