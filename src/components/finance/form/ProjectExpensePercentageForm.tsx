// ProjectExpensePercentageForm.tsx
import { zodResolver } from "@hookform/resolvers/zod";
import { useForm } from "react-hook-form";
import {
  ProjectExpensePercentageFormValues,
  ProjectExpensePercentageSchema,
...
interface ProjectExpensePercentageFormProps {
  projectId: string;
...
const ProjectExpensePercentageForm = ({
  projectId,
  addExpensePercentage,
}: ProjectExpensePercentageFormProps) => {
  ...
  const {
    ...
    resolver: zodResolver(ProjectExpensePercentageSchema),
    defaultValues: {
  ...
  const onSubmit = async (data: ProjectExpensePercentageFormValues) => {
    try {
      setSubmitError(null);
      const { error } = await addExpensePercentage(data);
...
export default ProjectExpensePercentageForm;
