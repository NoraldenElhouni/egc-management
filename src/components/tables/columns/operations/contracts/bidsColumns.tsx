...
import BidActionsCell from "../../../actions/bids/BidActionsCell";
...
export function getBidsColumns(
  onRefresh?: () => void,
): ColumnDef<RequestBids>[] {
  return [
    {
      id: "select",
      header: ({ table }) => (
    ...
    },
    {
      ...
      header: "الإجراءات",
      cell: ({ row }) => (
        <BidActionsCell bid={row.original} onRefresh={onRefresh} />
      ),
    },
  ];
}
