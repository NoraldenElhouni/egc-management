...
interface FinanceRequestPaymentsFiltersDialogProps {
  table: Table<FinanceRequestPayment>;
...
export default function FinanceRequestPaymentsFiltersDialog({
  table,
  statusOptions,
  projectOptions,
  contractorOptions,
  requesterOptions,
}: FinanceRequestPaymentsFiltersDialogProps) {
