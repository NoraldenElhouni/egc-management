...
// Phase 5 follow-up: the project-role picker that used to be here is
// gone. Distribution now writes project_distributions, which has no
// project role — a share and a job on the project are separate facts,
// and asking for a role to give someone money conflated the two.
//
// The other caller, PeriodDistributionEditForm, already ignored the two
// role arguments; it now simply stops being forced to choose one.
